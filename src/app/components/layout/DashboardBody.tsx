    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Link href="/deposit" className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 hover:border-blue-500 transition-colors text-center">
          ...
          <Link href="/withdraw" className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 hover:border-blue-500 transition-colors text-center">
            <div className="text-blue-600 mb-1">
              <svg className="w-6 h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/group" className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 hover:border-blue-500 transition-colors text-center">
            <div className="text-blue-600 mb-1">
              <svg className="w-6 h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/contact" className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 hover:border-blue-500 transition-colors text-center">
            <div className="text-blue-600 mb-1">
              <svg className="w-6 h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 lg:col-span-2">
            ...
            <div className="mb-6 rounded-lg overflow-hidden bg-gray-100 h-60 w-full flex flex-col items-center justify-center">
      <div className="relative h-60 w-full">
        <Image
          src="/home.jpeg" // Replace with your actual image path or URL
        ...
        />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li className="flex justify-between py-2 border-b border-gray-100">
                    ...
                    <span className="font-medium">10am - 6pm Daily</span>
                  </li>
                  <li className="flex justify-between py-2 border-b border-gray-100">
                  ...
                  <li className="flex justify-between py-2 border-b border-gray-100">
                    ...
                    <span className="font-medium">30% (Direct) + 3% (Indirect)</span>
                  </li>
                  <li className="flex justify-between py-2 border-b border-gray-100">
                  ...
                  <li className="flex justify-between py-2">
                    <span className="text-gray-500">Withdrawal Frequency:</span>
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-3">Investment Tiers</h3>
                <div className="overflow-auto max-h-80">
                  <table className="min-w-full divide-y divide-gray-200 text-sm">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Investment</th>
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Daily Return</th>
                      </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200">
                      {[
                        ...
                        <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                          <td className="px-4 py-2 whitespace-nowrap font-medium text-gray-900">{tier.investment}</td>
                          <td className="px-4 py-2 whitespace-nowrap text-green-600">{tier.return}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  type="number"
                  id="investment"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 text-black focus:border-blue-500"
              ...
              {calculatedReturn > 0 && (
                <div className="mt-6 p-4 bg-blue-50 rounded-md border border-blue-100">
                  <h3 className="text-lg font-medium text-blue-800 mb-2">Projected Returns</h3>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Daily Return:</span>
                      <span className="font-medium text-green-600">₦{calculatedReturn.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Weekly (7 days):</span>
                      <span className="font-medium text-green-600">₦{(calculatedReturn * 7).toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Monthly (30 days):</span>
                      <span className="font-medium text-green-600">₦{(calculatedReturn * 30).toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Plan Duration (60 days):</span>
                      <span className="font-medium text-green-600">₦{(calculatedReturn * 60).toLocaleString()}</span>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <h3 className="text-lg font-medium text-gray-900 mb-3">Mobile App</h3>
              <p className="text-sm text-gray-600 mb-4">Download our mobile app for easier access to your investments:</p>
              <div className="flex space-x-3">
                <button className="flex items-center justify-center bg-black text-white px-3 py-2 rounded-md text-sm">
